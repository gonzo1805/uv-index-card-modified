...
export class UVIndexCard extends LitElement {
  ...
  protected render(): TemplateResult | void {
    ...
    return html`
      <ha-card
        .header=${'Indice UV: ' + localize(uvRiskStr, '', '', this.config.language)}
          ...
          <div style="width: 100%; padding-left: 8px;">
            ...
            >
              ...
              <g id="UV-Index-Triangle" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <path d="M 10,10 H 45 V 40 H 10 Q 0,40 0,30 V 20 Q 0,10 10,10 Z" fill="${colours.low}"></path>

                <!-- Middle Segments -->
                <polygon
                  points="50,10 95,10 95,40 50,40"
                  fill="${stateValue >= 1 ? colours.low : colours.idle}"
                ></polygon>
                <polygon
                ...
                <polygon
                  ...
                  fill="${stateValue >= 3 ? colours.moderate : colours.idle}"
                ></polygon>
                <polygon
                  points="200,10 245,10 245,40 200,40"
                  fill="${stateValue >= 4 ? colours.moderate : colours.idle}"
                ></polygon>
                <polygon
                ...
                <polygon
                  ...
                  fill="${stateValue >= 6 ? colours.high : colours.idle}"
                ></polygon>
                <polygon
                ...
                <polygon
                  ...
                  fill="${stateValue >= 8 ? colours.veryHigh : colours.idle}"
                ></polygon>
                <polygon
                  points="450,10 495,10 495,40 450,40"
                  fill="${stateValue >= 9 ? colours.veryHigh : colours.idle}"
                ></polygon>
                <polygon
                ...
                <polygon
                  ...
                  fill="${stateValue >= 11 ? colours.extreme : colours.idle}"
                ></polygon>

                <!-- Last Segment (Fully Rounded Right Corners) -->
                <path
                  d="M 600,10 H 640 Q 650,10 650,20 V 30 Q 650,40 640,40 H 600 V 10 Z"
                  fill="${stateValue >= 12 ? colours.extreme : colours.idle}"
                ></path>
              </g>
            </svg>
          </div>
